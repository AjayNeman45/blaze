    ...
    >
      <Box sx={style}>
        ...
        <div className={styles.internal_statuses}>
          {mainStatusWithInternalStatuses?.[mainStatus]?.map((interStatus) => {
            return (
              <div key={uuid()} className={styles.input_box}>
                <input
                  type="radio"
                ...
                />
                <label htmlFor={interStatus?.value}>{interStatus?.label}</label>
              </div>
            );
          })}
          ...
          <div className={styles.btns}>
            <button
              ...
              disabled={internalStatus !== undefined ? false : true}
            >
              Confirm
            </button>
            <button
