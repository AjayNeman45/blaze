              ...
              <Grid container spacing={2} alignItems="flex-end">
                <Grid itme xs={7}>
                  <AlertCard
                    ...
                    unit="min"
                    expectedCount={survey?.expected_completion_loi}
                  />
                </Grid>
                <Grid item xs={5}>
                  <AlertCard
              ...
              <div className={styles.container2}>
                <div>
                  <AlertCard
                    ...
                    unit="%"
                    expectedCount={survey?.expected_incidence_rate}
                    alertMsg={"alert: LOW"}
                  />
                </div>
                <div>
          ...
          <div className={styles.right}>
            <div className={styles.client_statuses_card}>
              <StatusCard
                ...
                inClientCnt={miratsStatusesCnt?.in_client_survey}
              />
            </div>
      ...
      <div className={styles.main_boby}>
        ...
        <div>
          <LinearProgressWithLabel
            value={count > expectedCount ? 100 : (count * 100) / expectedCount}
          />
        </div>
