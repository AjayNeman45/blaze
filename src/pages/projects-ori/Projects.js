    ...
    <>
      ...
      <div className={styles.projectWrapper}>
        <div className={styles.projectHead}>
          <p className={styles.p}>Projects</p>
        ...
        {/* ----------------------------------------------------------------
                                 project identifiers  
         ----------------------------------------------------------------*/}
        <div className={styles.projectIdentifiersWrapper}>
          <p className={styles.p}>
            Projects are listed in reverse choronological order by date. In the
            'All Projects'
          </p>
          <div className={styles.projectIdentifiersBody}>
            <div>
              <p>
                <span
                  className={styles.indicator}
                  style={{ backgroundColor: "#1BC64B" }}
                ></span>
                {"\u00A0"}
                <span className={styles.gray}>signifies</span>
                {"\u00A0"}
            ...
            <div>
              <p>
                <span
                  className={styles.indicator}
                  style={{ backgroundColor: "#1765DC" }}
                ></span>
                {"\u00A0"}
                <span className={styles.gray}>signifies</span>
                {"\u00A0"}
                <span>"Testing / Awarded"</span>
              </p>
            </div>
            <div>
              <p>
        ...
        <div className={styles.projectFilterWrapper}>
          <form>
            ...
            <div className={styles.projectFilterSearch}>
              <input type="search" />
        ...
        <div className={styles.projectWrapper}>
         ...
         ----------------------------------------------------------------*/}
          <div className={styles.projectHeadingWrapper}>
            ...
            <div>
              <button className={styles.new_survey_btn}>
                Create New Survey
              </button>
            </div>
          </div>
