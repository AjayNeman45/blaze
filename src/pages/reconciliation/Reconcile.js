		...
		<>
			...
			<div className={styles.reconciliations_section}>
				...
				<div className={styles.instructions}>
					<p>
						1. &nbsp; The file to be uploaded with the ids should be
						in text (.txt) format
					</p>
					<p>
						2. &nbsp; Place each ID on one line. Empty lines will be
						ignored <a to='#'>(View Sample format)</a>
					</p>
					<p>
						3. &nbsp;The maximum size of the file should be 1MB or
						less.
					</p>
				</div>
				...
				<div className={styles.note}>
					...
					<p>
						Please do not reconcile a survey until it has been
						completed. Doing so may cause delays in field. If you
