			...
			case "language":
				setSurveyData({
					...
					country: {
						...
						code:
							e.target.value + "-" + surveyData?.country?.country,
					},
				})
				return
		...
		<div>
			<div className='basic_survey_info'>
				<div className='create_survey_left'>
					...
					<p className='subtitle'>
						This information will be visible on all across all our
						console
					</p>
					<InputHelperCard
				...
				<div className='create_survey_right'>
					...
					<div>
						...
						<input
							...
							onChange={e =>
								handleInputChange("no_of_completes", e)
							}
						/>
					</div>
				</div>
			...
			<div className='project_detail_info'>
				<div className='create_survey_left'>
					...
					<p className='subtitle'>
						Tell us about your project! is this survey belongs to a
						pre-existing project or it is going to be a new one.
						Adding surveys to project helps our team to organize
						surveyData.
					</p>
				</div>
				<div className='create_survey_right'>
					<div className='radio_input'>
						<label>
							Do you want this survey to add in the list of a
							specific pre-existing project? You need to have
							project ID to do the same
						</label>
