      ...
      >
        <Box sx={style}>
          <div className={styles.modal_container}>
            ...
            <div className={styles.createQualifications_mainContainer}>
              <div className={styles.createQualifications_leftSide}>
                ...
                <div className={styles.inputFild_container}>
                  ...
                  <div className={styles.is_core_demographic_container}>
                    <div>
                      <input
                        type="radio"
                        ...
                        id="yes"
                        value="true"
                        checked={dataToEdit?.is_core_demographic}
                        onChange={handleInputChange}
                      />
              ...
              <div className={styles.createQualifications_rightSide}>
                <div className={styles.inputFild_container}>
                  ...
                  <textarea
                    ...
                    cols="50"
                    value={
                      dataToEdit?.lang?.[defaultData[0].slice(0, 6)]
                        ?.question_text
                    }
                    onChange={(e) => {
                ...
                <div className={styles.inputFild_container}>
                  <p>Country</p>
                  <Select
                    value={defaultData[0]?.slice(0, 6).split("-")[1]}
                    options={countries}
                  />
                </div>
                <div className={styles.inputFild_container}>
                  <p>Language</p>
                  <select value={defaultData[0].slice(0, 6).split("-")[0]}>
                ...
                <p className={styles.subtitle}>Question ID : 1400382</p>
              </div>
            </div>

            <div className={styles.inputFild_container}>
              <p> Options Text</p>
              {dataToEdit?.lang?.[defaultData[0]?.slice(0, 6)]?.options?.map(
                (option, index) => {
                  return (
                    <input
                      type="text"
            ...
            <p
              onClick={() => {
                let countryLang = defaultData[0]?.slice(0, 6);
                let newOptions = dataToEdit?.lang?.[countryLang]?.options;
                newOptions.push("");
                setDataToEdit((prevData) => {
                  return {
                    ...prevData,
