...
function CreateSurveyGroupModal({ openModal, setOpenModal, surveyGrpNumber }) {
	const {
		surveyIdsOptions,
		setSurveyIdsOptions,
		surveyGrpData,
							...
							<div className={styles.createSurveyGroup_leftSide}>
								...
								<div className={styles.inputFild_container}>
									...
									<Select
										...
										value={surveyGrpData?.surveys?.map(
											sid => {
												return {
													label: sid,
													value: sid,
								...
								<p className={styles.subtitle}>
									{surveyGrpData?.surveys?.length} surveys
									included
								</p>
							</div>
							...
							<div className={styles.createSurveyGroup_rightSide}>
								...
								<div className={styles.inputFild_container}>
									...
									<select
										...
										value={
											surveyGrpData?.survey_group_status
										}
									>
