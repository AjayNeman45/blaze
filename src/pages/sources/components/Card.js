...
function Card({
	...
	function HandleRedirectsChange(e) {
		setSurveydata(preob => {
			...
			externalsuppliers[index].static_redirects[e.target.name] =
				e.target.value
			return {
				...preob,
		...
		<>
					...
					<DialogContent sx={{}}>
						{data?.global_redirect ? (
							...
							>
								...
								<p>
									You can only edit the global redirects from
									supplier settings.
								</p>
							</div>
						) : (
							<>
								...
								<div className={styles.field}>
									<TextField
										...
										fullWidth
										value={
											data?.static_redirects?.quota_full
										}
										name='quota_full'
										variant='outlined'
										onChange={e => {
								...
								<div className={styles.field}>
									<TextField
										...
										onChange={e => HandleRedirectsChange(e)}
										value={
											data?.static_redirects?.terminate
										}
										variant='outlined'
									/>
								</div>
			...
			<div className={styles.card}>
				...
				<select
					...
					onChange={e =>
						ChangeVendorStatus(index, e.target.value, surveyid)
					}
				>
