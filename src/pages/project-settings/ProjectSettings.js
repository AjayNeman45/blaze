              ...
              /> */}
				...
				<div className={styles.right}>
					...
					<TeamCard
						...
						accountManager={
							surveyData?.clients_team?.account_managers
						}
					/>
					{/* ****** PII Collection  */}
					...
					<div className={styles.black_btns}>
						...
						<button
							className={styles.black_btn}
							onClick={() =>
								history.push(`/viewredirects/${surveyID}`)
							}
						>
					...
					<div className={styles.device_compatibility_card}>
						...
						<div className={styles.device_compatibility_switch}>
							...
							<Switch
								...
								onChange={e =>
									handleDeviceCompatibilityChange(
										"mobile",
										e.target.checked
									)
								}
						...
						{surveyData?.mirats_insights_team?.sales_managers?.map(
							(sm, index) => {
								return (
									...
									>
										{peoples?.sales_managers?.map(
											anotherSM => (
												<option
													key={uuid()}
													value={anotherSM?.value}
												>
													{anotherSM.label}
												</option>
											)
						...
						{surveyData?.mirats_insights_team?.account_managers?.map(
							(am, index) => {
								return (
									...
									>
										{peoples?.account_managers?.map(
											anotherAM => (
												<option
													key={uuid()}
													value={anotherAM?.value}
												>
													{anotherAM.label}
												</option>
											)
