	...
	return (
		<div className={styles.preRedirectPage}>
			...
			<p className={styles.legend}>
				Test Survey Pre-screener Summary Session
			</p>
			<div className={styles.pre_screener_session}>
				...
				<div>
					...
					{survey?.external_suppliers?.map(supplier => {
						if (
							...
							testSession?.supplier_account_id
						) {
							return (
								<span key={uuid()}>
				...
				<div>
					...
					<span>
						{testSession?.date.toDate().toLocaleTimeString("en-in")}
					</span>
				</div>
			...
			<div className={styles.questionnaire_attempts}>
				{testSession?.responses?.map(res => {
					return (
						<div
							className={styles.questionnaire_attempt}
							key={uuid()}
						>
			...
			<div className={styles.technical_details}>
				<div>
					...
					<span>
						{testSession?.session_techincal_details?.browser_name}
					</span>
				</div>

				<div>
					<span>Os Type: </span>
					<span>{testSession?.session_techincal_details?.os}</span>
				</div>

				<div>
					<span>Device Type: </span>
					<span>
						{testSession?.session_techincal_details?.deviceType}
					</span>
				</div>
				...
				<div>
					<span>Platform: </span>
					<span>
						{testSession?.session_techincal_details?.platform}
					</span>
				</div>
				...
				<div>
					...
					<span>
						{testSession?.session_techincal_details?.version}
					</span>
				</div>
				...
				<div>
					<span>Language: </span>
					<span>
						{testSession?.session_techincal_details?.language}
					</span>
				</div>
				...
				<div>
					...
					<span>
						{testSession?.session_techincal_details?.user_agent}
					</span>
				</div>
			</div>
